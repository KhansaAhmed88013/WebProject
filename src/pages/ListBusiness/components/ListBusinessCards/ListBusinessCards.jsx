...
import './ListBusinessCards.css';
import GoogleMapList from "../../../../components/Mapmy/Maplist";
import { useLocation, useNavigate } from "react-router-dom";
import { useDispatch, useSelector } from "react-redux";
import { GetBusinesses } from "../../../../userService";
function ListBusinessCards() {
  ...
  console.log(item)
    ...
    useEffect(()=>
    {
      async function fetchbusiness(){
        try{
        const business=await GetBusinesses(item);
  ...
  <h2 className="business-heading">{business[0]?.category || "Business List"}</h2>
...
export default ListBusinessCards;
